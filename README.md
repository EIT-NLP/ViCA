...
- Orthogonal to Pruning Methods: Compatible with token pruning methods for further gains, e.g., combining with PDrop reduces visual computation to 2% with over 96% performance retention.
